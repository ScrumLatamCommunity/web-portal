...
export const Timeline = () => {
  return (
    <div className='relative flex h-[1485px] flex-col'>
      ...
      <div className='flex bg-[#F0F0F0] p-6'>
        ...
        <div className='relative flex-1'>
          ...
          <div className='absolute left-[10%] top-[600px]'>
            ...
            <p className='font-karla text-5 font-normal text-[#061D48]'>
              Se lanzan los talleres, ofreciendo sesiones prácticas y formativas
              que enriquecen el aprendizaje y la participación de los miembros.
            </p>
          </div>
