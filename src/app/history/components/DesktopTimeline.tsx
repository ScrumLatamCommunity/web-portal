...
export const DesktopTimeline = () => {
  ...
  return (
    <div className='mx-auto flex h-[770px] w-full flex-col items-center justify-start overflow-hidden bg-[#F0F0F0]'>
      ...
      <div className='flex w-full'>
        <div className='relative z-10 flex w-[3%] items-center justify-center shadow-lg'>
          <button
            onClick={() => scrollTimeline('left')}
            className='transition-opacity hover:opacity-70 focus:outline-none'
          >
            <ChevronLeft className='mb-[240px] h-[50px] w-[50px] cursor-pointer border-red-400 text-red-400' />
          </button>
        </div>
            ...
            <div className='relative flex h-auto font-darker-grotesque'>
              <div className='absolute left-16 top-[-30px] flex w-full max-w-[254px] whitespace-normal'>
                <p className='font-karla text-5 text-[#061D48]'>
                  ...
                  implementan los "Martes de Retrospectiva" y, a finales del
                  año, se lanzan los primeros webinars.
                </p>
              </div>
              <div className='absolute left-[399px] top-[-30px] flex w-full max-w-[254px] whitespace-normal'>
                <p className='font-karla text-5 text-[#061D48]'>
                  Se crean los Squads, equipos que fortalecen la colaboración y
                  el trabajo en grupo dentro de la comunidad.
                </p>
              </div>
              ...
              <div className='absolute left-[1401px] top-[-30px] flex w-full max-w-[254px] whitespace-normal'>
                <p className='font-karla text-5 text-[#061D48]'>
                  Se lanzan las membresías para los miembros de la comunidad y
                  se estrena el nuevo portal web, proporcionando una plataforma
        ...
        <div className='z-10 flex w-[3%] items-center justify-center shadow-lg'>
          <button
            onClick={() => scrollTimeline('right')}
            className='transition-opacity hover:opacity-70 focus:outline-none'
          >
            <ChevronRight className='mb-[240px] h-[50px] w-[50px] cursor-pointer border-red-400 text-red-400' />
          </button>
        </div>
      </div>
    </div>
