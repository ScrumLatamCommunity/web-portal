...
export const MobileTimeline = () => {
  return (
    <div className='flex'>
      <div className='relative flex h-[1500px] w-full flex-col'>
        <div className='flex h-10 items-center justify-center bg-[#f0f0f059]'>
          <ChevronUp />
        </div>
        ...
        <div className='flex bg-[#F0F0F0] p-6'>
          ...
          <div className='relative flex-1'>
            <div className='absolute left-[5%] top-[50px]'>
              <h2 className='font-darker-grotesque text-11 font-bold text-[#061D48]'>
                2020
              </h2>
              <p className='font-karla text-5 font-normal leading-[20px] text-[#061D48]'>
            ...
            <div className='absolute left-[5%] top-[335px]'>
              <h2 className='font-darker-grotesque text-11 font-bold text-[#061D48]'>
                2021
              </h2>
              <p className='font-karla text-5 font-normal leading-[20px] text-[#061D48]'>
            ...
            <div className='absolute left-[5%] top-[600px]'>
              <h2 className='font-darker-grotesque text-11 font-bold text-[#061D48]'>
                2022
              </h2>
              <p className='font-karla text-5 font-normal leading-[20px] text-[#061D48]'>
            ...
            <div className='absolute left-[5%] top-[880px]'>
              <h2 className='font-darker-grotesque text-11 font-bold text-[#061D48]'>
                2023
              </h2>
              <p className='font-karla text-5 font-normal leading-[20px] text-[#061D48]'>
            ...
            <div className='absolute left-[5%] top-[1150px]'>
              <h2 className='font-darker-grotesque text-11 font-bold text-[#061D48]'>
                2024
              </h2>
              <p className='font-karla text-5 font-normal leading-[20px] text-[#061D48]'>
