  ...
  return (
    ...
    >
      ...
      {image ? (
        ...
        <div
          className={`${darkerGrotesque.variable} flex h-[45px] w-[224px] flex-row items-center justify-center gap-[5px] rounded-[10px] bg-[#E6EAF0BF] text-[#141414]`}
        >
          <div className='flex h-[20px] w-[20px] items-center justify-center'>
            <UploadIcon stroke='#141414' strokeWidth={1} />
          </div>
          <p className='text-center text-[16px] font-normal'>Cargar imagen</p>
        </div>
      )}
    </div>
  )
