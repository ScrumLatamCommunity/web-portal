...
export default function EditSponsorProfile({
  ...
  return (
    ...
    >
      ...
      >
        <h1
          className={`items-left mb-5 ml-8 max-w-[1980px] text-[24px] font-darker-grotesque-700 text-[#082965]`}
        >
        ...
        <div className={`${inter.variable} flex w-full flex-row`}>
          <button
            className='my-6 ml-12 h-[60px] w-[66%] rounded-[10px] bg-[#FD3600] px-3 text-[#FFFFFF]'
            onClick={handleSave}
          >
            Guardar Perfil
          </button>
          <button
            className='mx-12 my-6 h-[60px] w-[33%] rounded-[10px] border-2 border-[#FD3600] bg-[#FFFFFF] px-3 text-[#FD3600]'
