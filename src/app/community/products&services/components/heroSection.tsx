    ...
    <section className='relative flex w-screen flex-col items-center justify-center md:mt-[-100px] md:w-full md:justify-between md:overflow-hidden'>
      ...
      <div className='flex flex-col md:mx-52 md:mt-[-10px] md:flex-row md:items-center md:justify-center'>
        <div className='relative m-6 flex h-full flex-col justify-center md:mt-20 md:w-[626px] md:px-6 md:pt-20'>
          <h1 className='pb-4 font-darker-grotesque text-3xl font-semibold text-[#FE2E00] md:pb-6 md:text-[48px] md:leading-1'>
            {title}
          </h1>
          <p className='pb-0 font-karla text-[#061D48] md:text-[30px]'>
            {description}
          </p>
        </div>
        <div className='relative flex flex-col items-center justify-around md:mt-[-50px] md:h-[550px]'>
          {image}
          <a
            className='pb-4 font-darker-grotesque text-lg font-bold text-[#082965] md:mb-0 md:hidden'
            href='#SQUAD'
          >
            {linkTitle}
          </a>
