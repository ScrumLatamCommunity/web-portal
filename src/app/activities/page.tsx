...
export default function Activities() {
  ...
  return (
    <>
      <div className='mx-auto w-full max-w-[1600px] px-4 sm:px-6 lg:px-6'>
        ...
        />
        <h2 className='my-7 pl-12 text-start font-darker-grotesque text-lg font-medium text-[#082965] lg:text-4xl'>
