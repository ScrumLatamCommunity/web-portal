...
export const WelcomeToCommunity = () => {
  ...
  return (
    <section className='flex flex-col pl-4 md:max-w-[1980px] md:items-center md:bg-gradient-to-tr md:from-red-300 md:to-transparent md:pl-0 xl:m-auto'>
      <div className='relative mx-auto flex flex-col items-center justify-center md:max-w-[1980px] md:flex-row'>
        ...
        <div className='font-darker-grotesque md:w-1/2 md:max-w-[1980px] md:pl-16 xl:pl-40'>
