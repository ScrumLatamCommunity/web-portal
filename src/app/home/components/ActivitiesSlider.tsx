...
export default function ActivitiesSlider({
  ...
  return (
    <div className='flex h-[500px] w-full flex-col gap-y-2 overflow-y-auto overflow-x-hidden px-3 py-2'>
      {activities.map((activity, i) => (
        ...
        >
          <div className='flex flex-row items-center'>
            <Image
              alt={activity.title}
              className='rounded-3xl object-cover p-3 md:h-[6.5rem] md:w-[6.5rem] 2xl:h-[7rem] 2xl:w-[7rem]'
              height={120}
              src={activity.image}
              width={120}
            />
