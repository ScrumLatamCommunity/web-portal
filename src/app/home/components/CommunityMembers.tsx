  ...
  return (
    <div className='relative w-full'>
      ...
      <div className='absolute left-1/2 top-1/2 z-20 flex w-[75%] -translate-x-1/2 -translate-y-1/2 flex-col rounded-2xl bg-white bg-opacity-75 md:left-[30%] md:w-[35%] md:bg-opacity-50 2xl:md:left-[30%] 2xl:w-[33%] 2xl:bg-opacity-50'>
        ...
        <p className='px-6 pb-6 font-darker-grotesque text-[14px] font-medium text-[#082965] md:p-16 md:pb-28 md:pt-6 md:text-[20px] 2xl:p-16 2xl:pb-28 2xl:pt-6 2xl:text-[26px]'>
          Scrum Latam Comunidad es donde los líderes transforman y las personas
          evolucionan. Juntos, impulsamos el cambio, inspiramos a otros y
          definimos el futuro de la agilidad en la región. ¡Sigamos avanzando!
        </p>
      </div>
    </div>
  )
