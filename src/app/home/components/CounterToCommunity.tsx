...
export const CounterToCommunity = () => {
  useCounter(counters)
  return (
    <section className='relative m-auto mt-8 max-w-screen-2xl font-darker-grotesque md:pb-16'>
      ...
      <div className='mb-5 mt-8 flex flex-wrap items-center justify-center gap-4 pt-12'>
      ...
      <div className='-mb-10 flex flex-wrap justify-center justify-items-center gap-x-16 md:mb-0 md:gap-16 xl:mt-14 xl:gap-36'>
