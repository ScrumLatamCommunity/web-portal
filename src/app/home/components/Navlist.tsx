...
export const Navlist: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className='relative flex-grow border-b-2 border-gray-200 lg:border-b-0'>
        <a
          className='md:item-start flex cursor-pointer items-center gap-2 py-2 pr-4 font-medium text-blue-7 hover:text-red-500 hover:underline sm:justify-between md:justify-between lg:justify-center'
