export const logos: { [key: string]: string } = {
  // 'img_logo' es la URL del logotipo principal de Scrum Latam.
  // Se utiliza principalmente en la barra de navegación o en la cabecera de la aplicación.
  scrum_logo_orange:
...
export const vectors: { [key: string]: string } = {
  vector1:
    'https://firebasestorage.googleapis.com/v0/b/scrum-latam-imgs.appspot.com/o/News%20component%2FVector%201.png?alt=media&token=3931dedf-c7f8-4b33-a20a-914eaa4e2689',
  vector2:
    'https://firebasestorage.googleapis.com/v0/b/scrum-latam-imgs.appspot.com/o/News%20component%2FVector%202.png?alt=media&token=580fab29-77db-4874-bc1e-de7b9baf6ce6',
  vector3:
  ...
  vector_horizontal1:
    'https://firebasestorage.googleapis.com/v0/b/scrum-latam-imgs.appspot.com/o/JoinOurCommunity%20component%2FRectangle%2034%20C.png?alt=media&token=a0af773a-bfa5-4a2f-b323-bb580dc0ef99',
  vector_horizontal2:
    'https://firebasestorage.googleapis.com/v0/b/scrum-latam-imgs.appspot.com/o/JoinOurCommunity%20component%2FRectangle%2035%20C.png?alt=media&token=cab0b4cf-f099-4b64-b692-edfd2ef5af00',
  vectorDesktopJoin1:
...
// Puedes agregar más propiedades a este objeto si necesitas incluir más imágenes.

export const images: {
  imagesData: string[]
  goal_logo: string
  joinSectionMobile: string
  ...
  imagesData: [
    ...
    'https://firebasestorage.googleapis.com/v0/b/scrum-latam-imgs.appspot.com/o/Info%20Community%20component%2Fimg%202%20community.png?alt=media&token=14d0d0b5-04ce-4a0b-b608-0c9812abf3e9',
  ...
  founder: [
    'https://firebasestorage.googleapis.com/v0/b/scrum-latam-imgs.appspot.com/o/History%2FFounder%2FTarget.svg?alt=media&token=673a10ad-1c67-4cb5-b3cb-1f4f2449b09a',
